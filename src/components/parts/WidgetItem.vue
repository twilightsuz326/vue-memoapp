<template>
    <div class="widget-family">
        <div class="widget" 
            ...
            <input v-model="widgettext" class="transparent" placeholder="本文" />
        ...
        <div class="child-widget">
            <WidgetItem v-for="childWidget in widget.children" v-bind:widget="childWidget" v-bind:parentWidget="widget"
                ...
                @parentMouseOver="onChildrenMouseOver"
                @parentMouseLeave="onChildrenMouseLeave"
...
export default {
    ...
    data() {
        return {
            widgettext: this.widget.text,
        };
    },
    methods: {
        onMouseOver: function () {
            this.$emit('parentMouseOver', this.widget);
        },
        onMouseLeave: function () {
            this.$emit('parentMouseLeave', this.widget);
        },
        onChildrenMouseOver: function (widget) {
            this.$emit('parentMouseOver', widget);
        },
        onChildrenMouseLeave: function (widget) {
            this.$emit('parentMouseLeave', widget);
        },
